...
def plot_classification_dataset(X, y, colors = ['r', 'b'], xticks=[], yticks=[], title="", show_legend=True, savefig_path=None):
    """
...
def plot_2d_decisionboundary(model, X, y, colors = ['r', 'b'], xticks=[], yticks=[], title="", show_legend=True, savefig_path=None):
    """
